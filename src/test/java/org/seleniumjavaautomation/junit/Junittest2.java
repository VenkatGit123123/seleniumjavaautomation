...
public class Junittest2 {
	...
	//Ignore tag will skip the below method
	@Ignore
	@Test
	 public void testMethod4() throws InterruptedException {
	 driver.findElement(By.xpath("//input[@name='fname']")).sendKeys("junittest2 class-testMethod4");
	 Thread.sleep(2000);
	 System.out.println("\njunittest2 class-testMethod4 is executed");
	 }
